...
get_siope_officials(year, period, state, type = NULL, use_cache = TRUE,
  verbose = FALSE,
...
A [tibble](https://tibble.tidyverse.org/reference/tibble.html) with 35
columns including official names, CPFs, roles, and contact information.
