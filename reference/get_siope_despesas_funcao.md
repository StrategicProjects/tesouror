...
Retrieves education expenses broken down by government function (e.g.,
...
get_siope_expenses_by_function(year, period, state, type = NULL,
...
A [tibble](https://tibble.tidyverse.org/reference/tibble.html) with 12
columns including function codes and expense values.
