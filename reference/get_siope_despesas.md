...
Retrieves education spending data broken down by expense categories for
...
get_siope_expenses(year, period, state, type = NULL, use_cache = TRUE,
  verbose = FALSE,
...
A [tibble](https://tibble.tidyverse.org/reference/tibble.html) with 21
columns including expense categories and values.
