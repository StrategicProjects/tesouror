...
National Treasury ('Tesouro Nacional') and related government APIs.
Covers six data sources: 'SICONFI'
...
spending data. Features automatic pagination, in-memory caching, retry
logic, and tidy output.
...
- <https://strategicprojects.github.io/tesouror/>

- Report bugs at <https://github.com/StrategicProjects/tesouror/issues>
